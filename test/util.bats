...
function test_filtering_helper {
	...
	if [ "$expected_components" == "all" ]; then
		expected_components="good error neutral bad"
	fi
...
@test ici_filter_true {
	test_filtering_helper 0 "good" ici_filter "good"
}
@test ici_filter_false {
	test_filtering_helper 1 "good" ici_filter "good"
}
@test ici_filter_out_true {
	test_filtering_helper 0 "good error neutral" ici_filter_out "bad"
}
